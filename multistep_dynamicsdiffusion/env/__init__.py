...
MBPO_ENVIRONMENT_SPECS = (
    {
        ...
        "entry_point": (f"multistep_dynamicsdiffusion.env.ant:AntTruncatedObsEnv"),
        "max_episode_steps": 1000,
    },
    {
        "id": "HumanoidTruncatedObs-v2",
        "entry_point": (
            f"multistep_dynamicsdiffusion.env.humanoid:HumanoidTruncatedObsEnv"
        ),
        "max_episode_steps": 1000,
    },
)
...
PETS_ENVIRONMENT_SPECS = (
    {
        "id": "PetsCheetah-v0",
        "entry_point": (f"multistep_dynamicsdiffusion.env.pets_cheetah:PetsCheetahEnv"),
        "max_episode_steps": 1000,
    },
    {
        "id": "PetsReacher-v0",
        "entry_point": (f"multistep_dynamicsdiffusion.env.pets_reacher:PetsReacherEnv"),
        "max_episode_steps": 150,
    },
    {
        "id": "PetsPusher-v0",
        "entry_point": (f"multistep_dynamicsdiffusion.env.pets_pusher:PetsPusherEnv"),
        "max_episode_steps": 150,
    },
)
