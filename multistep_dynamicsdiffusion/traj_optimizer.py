...
from .utils import AcceleratorManager
...
class TrajectoryOptimizer:
    ...
    def __init__(
        ...
        self.initial_solution = (
            ...
            .float()
            .to(AcceleratorManager.get_accelerator().device)
        )
...
class TrajectoryOptimizerAgent(Agent):
    ...
    def __init__(
        ...
        self.trajectory_eval_fn: TrajectoryEvalFnType = None
        self.actions_to_use: List[np.ndarray] = []
        self.replan_freq = replan_freq
        self.verbose = verbose

    def set_trajectory_eval_fn(self, trajectory_eval_fn: TrajectoryEvalFnType):
    ...
    def plan(self, obs: torch.Tensor, **_kwargs) -> torch.Tensor:
        """Issues a sequence of actions given an observation.
